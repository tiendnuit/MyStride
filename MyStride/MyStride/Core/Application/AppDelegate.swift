...
class AppDelegate: UIResponder, UIApplicationDelegate, NavigatorHandler {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedStringKey.font:R.font.montserratBold(size: 16)!, NSAttributedStringKey.foregroundColor:UIColor.white]
        UINavigationBar.appearance().isTranslucent = false
        UINavigationBar.appearance().barTintColor = UIColor.StrideGreen
